...
TRAIN_TASKS="${TRAIN_TASKS:-${PROJECT_ROOT}/data/rl/smoke_v1_768/train_tasks.jsonl}"
VAL_TASKS="${VAL_TASKS:-${PROJECT_ROOT}/data/rl/smoke_v1_768/val_tasks.jsonl}"
WORK_DIR="${WORK_DIR:-${PROJECT_ROOT}/data/rl/smoke_v1_768/slime}"
